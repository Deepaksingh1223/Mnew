                      ...
                      <div className="container-fluid p-0">
                        <div className="row g-0">
                          <div className="col-12 mxd-grid-item no-margin">
                            <div
                              className="mxd-section-title__title anim-uni-in-up"
                              style={{
                                translate: "none",
                                rotate: "none",
                                scale: "none",
              ...
              <div className="col-12 col-xl-7">
                ...
                >
                  ...
                  >
                        ...
                        >
                          <div className="mxd-testimonials-card bg-base-tint radius-m">
                            <div className="mxd-testimonials-card__content">
                              <div
                                className="mxd-testimonials-card__media anim-uni-in-up"
                                style={{
                                  translate: "none",
                                  rotate: "none",
                                  scale: "none",
                    ...
                    <div
                      className="swiper-button-prev mxd-slider-btn mxd-slider-btn-round-prev animate-card-2"
                      style={{
                        translate: "none",
                        rotate: "none",
                        scale: "none",
                    ...
                    <div
                      className="swiper-button-next mxd-slider-btn mxd-slider-btn-round-next animate-card-2"
                      style={{
                        translate: "none",
                        rotate: "none",
                        scale: "none",
